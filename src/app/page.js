            ...
            <div className="relative z-10 h-full w-full grid grid-rows-[minmax(52px,13%)_minmax(250px,52%)_minmax(145px,35%)] md:grid-rows-[minmax(66px,12%)_minmax(380px,56%)_minmax(104px,32%)] 2xl:grid-rows-[minmax(98px,12%)_minmax(400px,1fr)_minmax(168px,20%)] [@media(min-width:1920px)]:grid-rows-[minmax(116px,13%)_minmax(500px,1fr)_minmax(185px,19%)] [@media(min-width:2560px)]:grid-rows-[minmax(138px,14%)_minmax(590px,1fr)_minmax(215px,18%)]">
                ...
                <div className="w-full z-20 flex items-end justify-center px-2 pb-1.5 pt-10 sm:pt-7 md:pt-0 md:pb-4 2xl:pb-6 [@media(min-width:1920px)]:pb-8 [@media(min-width:2560px)]:pb-9 min-h-0">
                    <div className="w-full max-w-[98vw] md:max-w-[74vw] xl:max-w-[1080px] 2xl:max-w-[1240px] [@media(min-width:1920px)]:max-w-[1400px] [@media(min-width:2560px)]:max-w-[1600px] origin-bottom translate-y-[12px] sm:translate-y-[8px] md:translate-y-0 scale-[1.11] sm:scale-[1.2] md:scale-[0.68] 2xl:scale-[0.75] [@media(min-width:1920px)]:scale-[0.82] [@media(min-width:2560px)]:scale-[0.9] relative">
                        ...
                        {audioUrl && (
                            <div className="absolute right-0 top-10 -translate-y-1/2 md:top-16 md:translate-y-0 pr-2 md:pr-4 translate-x-[-6px] md:translate-x-[-10px] z-40 pointer-events-auto">
