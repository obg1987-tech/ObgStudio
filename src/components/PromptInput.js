...
export const GENRES = [
    { id: 'Rock', label: 'Rock', emoji: '🎸', glow: 'shadow-[0_0_15px_rgba(239,68,68,0.5)]', color: 'bg-[#ff7a70]/30 border-[#ff7a70]/50 text-white', hex: '#ef4444' },
    { id: 'Hip-hop', label: 'Hip-hop', emoji: '🎧', glow: 'shadow-[0_0_15px_rgba(168,85,247,0.5)]', color: 'bg-[#9884ff]/30 border-[#9884ff]/50 text-white', hex: '#a855f7' },
    { id: 'K-Pop', label: 'K-Pop', emoji: '🎹', glow: 'shadow-[0_0_15px_rgba(236,72,153,0.5)]', color: 'bg-[#ff75d8]/30 border-[#ff75d8]/50 text-white', hex: '#ec4899' },
    { id: 'Lullaby', label: 'Lullaby', emoji: '🌙', glow: 'shadow-[0_0_15px_rgba(59,130,246,0.5)]', color: 'bg-[#5eead4]/30 border-[#5eead4]/50 text-white', hex: '#3b82f6' },
    { id: 'Jazz', label: 'Jazz', emoji: '🎵', glow: 'shadow-[0_0_15px_rgba(245,158,11,0.5)]', color: 'bg-[#fcd34d]/30 border-[#fcd34d]/50 text-white', hex: '#f59e0b' },
];
